...
define([
    ...
    return UiSelect.extend({
        ...
        initMapping: function () {
            this.valuesMap['single_choice'] = 'select';
            this.valuesMap['multiple_choice'] = 'select';
            this.valuesMap['essay'] = 'text';

            this.indexesMap['options'] = 'select';
            this.indexesMap['container_type_content'] = 'text';
